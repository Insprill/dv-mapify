...
namespace RuntimeHandle
{
    ...
    public class RuntimeTransformHandle : MonoBehaviour
    {
        ...
        {
            HandleBase.HandleShader = assetBundle
                .LoadAsset<Shader>($"{assetsFolderPath}shaders/handleshader.shader");

            if (HandleBase.HandleShader == null)
            {
                throw new Exception("Failed to load HandleBase.HandleShader");
            }

            RotationAxis.AdvancedHandleShader = assetBundle
                .LoadAsset<Shader>($"{assetsFolderPath}shaders/advancedhandleshader.shader");
